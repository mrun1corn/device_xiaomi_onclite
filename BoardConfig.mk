...
BOARD_ONC_DYNAMIC_PARTITIONS_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_ONC_DYNAMIC_PARTITIONS_PARTITION_LIST := odm product system system_ext vendor
ifneq ($(WITH_GMS),true)
